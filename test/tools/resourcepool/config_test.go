...
const (
	...
	pf1Capability  resourcepoolapi.Capability = "10G"
	pf2Capability  resourcepoolapi.Capability = "20G"
	pf3Capability  resourcepoolapi.Capability = "30G"
)
...
func TestReadConfigFile(t *testing.T) {
	...
	assert.Equal(t, &resourcepool.Config{
		HostName: hostName,
		PhysicalFunctions: map[string]resourcepoolapi.Capability{
